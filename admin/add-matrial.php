    ...
    if (isset($_POST['submit'])) {
      ...
      if (empty(trim($date))) {
        ...
        if (!empty($title) && !empty($description) && !empty($date)) {
          $sql = "INSERT INTO materi (date, title, description, foto, member_id) VALUES ('{$date}','{$title}','{$description}','{$nm_file}','{$member_id}')";
...
<div class="row">
    ...
    <div class="column middle">
        <h2>Mattrial Form </h2>
        <p> Please fill in your mattrial in the following form </p>
    <div class="container">
        <form action="add-matrial.php" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
                ...
                <div class="col-75">
                  <input type="text" id="tbDate" name="date" placeholder="date post..">
        ...
        <div class="row">
                <div class="col-25">
                  <label for="title">Mattrial Name</label>
                </div>
                <div class="col-75">
                  <input type="text" id="title" value="<?php echo $title; ?>" name="title" placeholder="Your mattrial name..">
        ...
        <div class="row">
                  <div class="col-25">
                    <label for="bio">Cover</label>
                  </div>
                  <div class="col-75">
                    <input type="file" name="foto" placeholder="Your Cover..">
                  </div>
              </div>
        ...
        <div class="row">
                  <div class="col-25">
                    <label for="bio">Mattrial</label>
                  </div>
                  <div class="col-75">
                    <input type="file" name="foto" placeholder="Your mattrial..">
                  </div>
              </div>
