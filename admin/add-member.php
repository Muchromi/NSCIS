...
//password
      ...
      if($ukuran_file > $size){
        ...
        if (!empty($id_member) && !empty($first_name) && !empty($last_name) && !empty($full_name) && !empty($email) && !empty($dob) && !empty($gender) && !empty($religion) && !empty($no_hp) && !empty($bio) && !empty($address) && !empty($place_birth) && !empty($status)) {
          $sql = 'INSERT INTO member (id_member, first_name, last_name, full_name, email, no_hp, bio, dob, file_gambar, position_id, gender, religion, password, address, place_birth, status) ';
          $sql .= "VALUES ('{$id_member}','{$first_name}','{$last_name}','{$full_name}','{$email}','{$no_hp}','{$bio}','{$dob}','{$nm_file}','{$position}','{$gender}','{$religion}','{$hash}','{$address}', '{$place_birth}', '{$status}')";
          ...
          <div class="container">
           ...
           <!-- id member -->
            <div class="row">
                ...
                <div class="col-75">
                  <input type="text" id="fname" name="id_member" value="<?php echo $id_member; ?>" placeholder="Your id..">
...
<!-- full name -->
              <div class="row">
                ...
                <div class="col-75">
                  <input type="text" id="lname" name="full_name" value="<?php echo $full_name; ?>" placeholder="Your full name..">
              ...
              <div class="row">
                ...
                <div class="col-75">
                  <input type="text" id="fname" name="religion" value="<?php echo $religion; ?>" placeholder="Your Religion..">
...
<!-- no phone -->
              <div class="row">
                  ...
                  <div class="col-75">
                    <input type="text" id="no_hp" value="<?php echo $no_hp; ?>" name="no_hp" placeholder="Your No. Phone..">
