<?php
    ...
    $sql_count = "SELECT COUNT(*) FROM announce";
    if (isset($sql_where)) {
    $sql .= $sql_where;
    $sql_count .= $sql_where;
    }
...
<div class="row">
    ...
    <div class="col-75">
        ...
        <?php
        echo '<a href="add-announce.php" class="btn btn-large"><i class="fa fa-plus" aria-hidden="true"></i> Announce</a>';
        ?>

        <p> Data of all staf officier announce</p>
            ...
            <table>
                ...
                <?php while($row = mysqli_fetch_array($result)): ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-default" href="ed.php?id=<?php echo $row['id_announce'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
